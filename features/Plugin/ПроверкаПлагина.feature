...
Функционал: Проверка конфигурации через gitsync
	...
	И Я создаю файл настроек проверки и сохраняю в переменной "ФайлНастроек"
	И Я заполняю файл настроек проверки из переменной "ФайлНастроек" значениями:
		|Wait            |5               |
		|MaxWait         |900             |
	...
	И Я собираю плагин и сохраняю его в переменной "ПлагинПроверки"
	...
	И Я сохраняю путь к исходным кодам тестовой конфигурации в "КаталогИсходников"
	...
	И Я создаю файловое хранилище из базы "КаталогБазы" и сохраняю в переменную "КаталогХранилища"
	...
	Тогда Файл "ФайлSonarQube" не существует
