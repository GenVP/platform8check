...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ЯОбрабатываюОшибкиВТаблицеИСохраняюВФайлДляПроекта");
...
//Я обрабатываю ошибки в таблице "ТаблицаОшибок" и сохраняю в файл "ФайлРезультата" для проекта "TEST"
Процедура ЯОбрабатываюОшибкиВТаблицеИСохраняюВФайлДляПроекта(ТаблицаОшибок, ФайлРезультата, ИмяПроекта) Экспорт

	ГенераторОтчета = Новый ГенераторОтчетaSonarQube();
	ГенераторОтчета.ВыгрузитьОшибкиВФайл(
		ЗаменитьПеременнуюВЗначении(ТаблицаОшибок),
		ЗаменитьПеременнуюВЗначении(ИмяПроекта),
		ЗаменитьПеременнуюВЗначении(ФайлРезультата));
